...
{
   images[i-1].setAttribute("src","../ASSET/IMAGE/satellite/"+i+".jpg")
...
function inc()
{
    ...
    {
        indval = 0;
    document.getElementById("header").style.backgroundImage="url(../ASSET/IMAGE/satellite/"+imgarr[indval]+")"
    }
    else
    {
    document.getElementById("header").style.backgroundImage="url(../ASSET/IMAGE/satellite/"+imgarr[indval]+")"
...
function openImg(pic,name,info)
{
    ...
    document.getElementById("subWindowImg").src='../ASSET/IMAGE/satellite/'+pic+'.jpg'
